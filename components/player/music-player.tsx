  ...
  return (
    <AnimatePresence>
      {currentSong ? (
        ...
        >
          <div className="mx-auto flex max-w-6xl items-center gap-3 rounded-2xl border border-border glass-strong px-3 py-2.5 glow-purple sm:gap-5 sm:px-5 sm:py-3">
            {/* Track info */}
            ...
            <span
              onClick={() => close()}
              style={{ backgroundColor: "oklch(0.62 0.23 300)" }}
              className=" rounded-full  absolute right-10 top-[-10] cursor-pointer"
            >
              <X />
            </span>
          </div>
