...
export function Topbar({ onMenuClick, onQuickAdd, user, logout }: TopbarProps) {
  return (
    <header className="glass sticky top-3 z-30 flex items-center gap-3 rounded-2xl px-4 py-3">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger
            render={
              <Button
                variant="ghost"
                size="icon"
                className="relative rounded-full border border-glass-border"
          ...
          <DropdownMenuContent
            align="end"
            className="glass w-72 rounded-2xl border-glass-border p-2"
          >
